...
console.log(myForEach(myNames, result)); // undefined
...
const myNums1 = [1, 4, 9, 16];

// Pass a function to map
const myDoubledNums = myMap(myNums1, (x) => x * 2);
...
const Nums1 = [1, 2, 3];
const firstEvenNum = myFind(Nums1, (num) => num % 2 === 0);
console.log(firstEvenNum)
const myNames1 = ['Alice', 'Bob', 'Charlie', 'Debbie', 'Barry'];
const nameHasB = myFind(myNames1, (name) => name.includes('B'));
